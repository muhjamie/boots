 ...
 final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();
  ...
  Widget _label(){
    return Container(
      child:Column(
        children: <Widget>[
          customText('Forgot Password',style:TextStyle(fontSize: 24,fontWeight: FontWeight.bold)),
          SizedBox(height: 15),
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 20),
            child: customText('Enter your email address below to receive password reset instruction',
          style:TextStyle(fontSize: 18,fontWeight: FontWeight.w400,color: Colors.black54),textAlign: TextAlign.center),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      key: _scaffoldKey,
      appBar: AppBar(
        title: customText('Forgot Password',context: context,style: TextStyle(fontSize: 20)),
        centerTitle: true,
      ),
      body: _body(context),
    );
