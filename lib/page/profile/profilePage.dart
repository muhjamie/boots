...
import 'package:boots/page/profile/widgets/tabPainter.dart';
import 'package:boots/state/authState.dart';
import 'package:boots/state/chats/chatState.dart';
...
import 'package:boots/widgets/newWidget/rippleButton.dart';
...
class ProfilePage extends StatefulWidget {
  ProfilePage({Key key, this.profileId, this.scaffoldKey}) : super(key: key);
    ...
    return authstate.isbusy
        ...
        : list == null || list.length < 1
            ? Container(
                ...
                child: NotifyText(
                  title: isMyProfile
                      ? 'You haven\'t ${isreply ? 'replied to any post' : isMedia ? 'posted any media yet' : 'posted anything yet'}'
                      : '${authstate.profileUserModel.userName} hasn\'t ${isreply ? 'replied to any post' : isMedia ? 'posted any media yet' : 'posted anything yet'}',
        ...
        Padding(
          ...
          child: Row(
            children: <Widget>[
              ...
              SizedBox(width: 10),
              customText(user.ppa == null && user.localGovt == null && user.stateOfDeployment == null ? " " : user.ppa + ", " + user.localGovt + ", " + user.stateOfDeployment,
