      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          SettingRowWidget(
            "Precise location",
            subtitle:
                'Disabled \n\n\nIf enabled, Boots will collect, store, and use your device\'s precise location, such as your GPS information. This lets Boots improve your experience - for rxample, showing you mpre local content, ads, and recommendations.',
          ),
          HeaderWidget(
