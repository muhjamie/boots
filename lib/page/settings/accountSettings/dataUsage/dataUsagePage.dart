      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          SettingRowWidget(
            ...
            showDivider: false,
            subtitle:
                'When enabled, video won\'t autoplay and lower-quality images load. This automatically reduces your data usage for all Boots accounts on this device.',
          ),
          Divider(height: 0),
          HeaderWidget('Images'),
          SettingRowWidget(
          ...
          SettingRowWidget(
            null,
            subtitle:
                'Allow Boots to sync data in the background to enhance your experience.',
            vPadding: 10,
          ),
        ],
      ),
