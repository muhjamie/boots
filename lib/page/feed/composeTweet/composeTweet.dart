...
import 'package:boots/page/feed/composeTweet/widget/composeBottomIconWidget.dart';
import 'package:boots/page/feed/composeTweet/widget/composeTweetImage.dart';
import 'package:boots/page/feed/composeTweet/widget/widgetView.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        ...
        isCrossButton: true,
        submitButtonText:
            widget.isTweet ? 'Post' : widget.isRetweet ? 'Comment' : 'Comment',
        isSubmitDisable:
      ...
      children: <Widget>[
        TextField(
          ...
          decoration: InputDecoration(
              ...
              hintText: isTweet
                  ? 'What\'s happening?'
                  : isRetweet ? 'Add a comment' : 'Post your reply',
