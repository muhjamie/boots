    ...
    return InkWell(
      ...
      child: Row(
        children: <Widget>[
          customText(
            '$count ',
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17, color: AppColor.white),
          ),
          customText(
            '$text',
      ...
      leading: icon == null
          ...
          : Padding(
              ...
              child: customIcon(
                ...
                icon: icon,
                size: 25,
                iconColor: isEnable ? AppColor.white : AppColor.lightGrey,
              ),
            ),
      title: customText(
        title,
              ...
              Padding(
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    ...
                    Divider(),
                    _menuListRowButton('Communities',
                      icon: AppIcon.homeFill, isEnable: true, onPressed: () {
                      _navigateTo('CommunitiesPage');
                    }),
                    _menuListRowButton('Nearby People', icon: AppIcon.viewHidden, isEnable: true, onPressed: () {
                      _navigateTo('NearbyPage');
                    } ),
                    _menuListRowButton('Maps', icon: AppIcon.locationPin, isEnable: true, onPressed: () {
                      _navigateTo('MapPage');
                    } ),

                    //_menuListRowButton('Marketplace', icon: AppIcon.bookmark),
                    //_menuListRowButton('Sell', icon: AppIcon.moments),
                    //_menuListRowButton('Boot ads', icon: AppIcon.twitterAds),
/*                  Divider(),
