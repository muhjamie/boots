...
class CommunitiesSearchPage extends StatefulWidget {
  @override
  _CommunitiesSearchPageState createState() => _CommunitiesSearchPageState();
}

class _CommunitiesSearchPageState extends State<CommunitiesSearchPage> {
        ...
        onTap: () async {
          ...
          if(_isJoined) {
            ...
            Future.delayed(Duration(milliseconds: 2000), () {
              //Navigator.of(context).push(MaterialPageRoute(builder: (context) => ChatPage(communityId: groupId, userId: userName, communityName: groupName)));
            });
          }
          else {
            setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Search', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color: Colors.white)),
      ),
