...
import 'package:boots/widgets/tweet/widgets/parentTweet.dart';
import 'package:boots/widgets/tweet/widgets/tweetIconsRow.dart';
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: GestureDetector(
            ...
            child: model.user.userId == authstate.profileUserModel.userId ? customImage(context, authstate.profileUserModel.profilePic) : customImage(context, model.user.profilePic),
          ),
        ),
        SizedBox(width: 20),
        Container(
