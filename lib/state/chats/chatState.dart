...
import 'package:boots/model/chatModel.dart';
...
class ChatState extends AppState {
  ...
  User _chatUser;
  String serverToken = "AAAAeHHQZ8Y:APA91bEKe9-Y7cZ4P3-vv6JYOoeQfsuioNOBeSkKHgKvqffdnWA-LjgEge0gssfd9OG48pE6pBjpjt2ML4YCGrui9HcvKZ3C9Ju0_Mfvm8LVee_cbnTizcQ2a1NE8P-nhjkWzGYtoDsp";
  ...
  ///  ``` json
  ///  {
  ///    "key": "AAAAeHHQZ8Y:APA91bEKe9-Y7cZ4P3-vv6JYOoeQfsuioNOBeSkKHgKvqffdnWA-LjgEge0gssfd9OG48pE6pBjpjt2ML4YCGrui9HcvKZ3C9Ju0_Mfvm8LVee_cbnTizcQ2a1NE8P-nhjkWzGYtoDsp"
  ///  } ```
  ...
  void getFCMServerKey() async {
    ...
    if (data != null) {
      serverToken = json.decode(data)["key"];
    }
  }
